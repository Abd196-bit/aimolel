...
# Initialize AI components (delayed initialization to avoid blocking startup)
db_manager = None
auth_manager = None
rate_limiter = None
...
def init_ai_components():
    """Initialize AI components - called on first request"""
    global db_manager, auth_manager, rate_limiter, inference_engine, api_endpoints
    
    if db_manager is None:
        logger.info("Initializing DieAI components...")
        ...
        # Set up learning service
        logger.info("Setting up learning service...")
        ...
        logger.info("DieAI components initialized successfully!")
